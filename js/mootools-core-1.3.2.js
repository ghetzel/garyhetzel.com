...
web build:
 - http://mootools.net/core/c8eb5f9430d4a175b7b7baa09ebab27f

packager build:
 - packager build Core/Core Core/Array Core/String Core/Number Core/Function Core/Object Core/Class Core/Class.Extras Core/Element Core/DOMReady
...
for(var e=g[0];e--;){h=h.firstChild;}this.empty().adopt(h.childNodes);}else{this.innerHTML=f;}}};b.erase=b.set;return b;})();var Event=new Type("Event",function(a,i){if(!i){i=window;
